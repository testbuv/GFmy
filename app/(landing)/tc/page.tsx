          ...
          <LandingNav />
            ...
            <div className="max-w-5xl mx-auto bg-white p-8 rounded-lg shadow-md space-y-6 prose prose-blue">
                    ...
                    <section className="space-y-4">
                        ...
                        <p>1.1 These general terms and conditions (the “General Conditions”) apply when you as a consumer (the “Customer”) place an order via www.Growth Fast.io.shop and related pages, (the “Website”). The agreement is concluded between you and Company, company reg. no.xxxxx. Detailed contact information and other information about Growth Fast.io are set forth on the Website. The General Conditions are only applicable for Customers that are consumers.</p>
                    ...
                    <section className="space-y-4">
                        ...
                        <p>Growth Fast.io shall not be liable or deemed to be in breach of contract by reason of any delay in performing, or failure to perform, any of its obligations if the delay or failure was due to any cause beyond its reasonable control. Notwithstanding contrary clauses in this Agreement, in the event that Growth Fast.io.shop are deemed liable to you for breach of this Agreement, you agree that Growth Fast.io.shop liability is limited to the amount actually paid by you for your services, which amount calculated in reliance upon this clause. You hereby release Growth Fast.io from any and all obligations, liabilities and claims in excess of this limitation.</p>
                    </section>
                    <section className="space-y-4">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-semibold text-slate-800">15. APPLICABLE LAW AND DISPUTE RESOLUTIONS</h2>
                        <p>Growth Fast.io shall not be liable or deemed to be in breach of contract by reason of any delay in performing, or failure to perform, any of its obligations if the delay or failure was due to any cause beyond its reasonable control. Notwithstanding contrary clauses in this Agreement, in the event that Growth Fast.io.shop is deemed liable to you for breach of this Agreement, you agree that Growth Fast.io.shop's liability is limited to the amount actually paid by you for your services, calculated in reliance upon this clause. You hereby release Growth Fast.io from any and all obligations, liabilities, and claims in excess of this limitation.</p>
                    </section>
                </div>
            </main>
