        ...
        <>
          <LandingNav />
            ...
            <div className="max-w-5xl mx-auto bg-black p-8 rounded-lg shadow-md space-y-6 prose prose-blue">
                    ...
                    <section className="space-y-4">
                    <h2 className="text-2xl font-semibold text-gray-200">
                    13. CHANGES TO THE GENERAL CONDITIONS</h2>
                    ...
                    <section className="space-y-4">
                    <h2 className="text-2xl font-semibold text-gray-200">
                    15. APPLICABLE LAW AND DISPUTE RESOLUTIONS</h2>
                    ...
                    <section className="space-y-4">
                    <h2 className="text-2xl font-semibold text-gray-200">
                    14. DISCLAIMER AND WARRANTIES</h2>
