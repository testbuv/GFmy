        ...
        <>
            ...
            <main className="bg-gray-100 text-slate-900 py-12">
             ...
             <h1 className="text-3xl font-bold mb-6 border-b pb-3 text-center text-slate-800">PRIVACY POLICY</h1>
                    ...
                    <p>ai.Growth Fast.io.shop captures and stores information about end-users, such as IP addresses and data submitted via our API. We do not sell, share, or rent out this data.</p>
                    ...
                    <p>For any privacy-related inquiries or complaints, please contact us at hello@Growth Fast.io.shop</p>
                </div>
            </main> 
