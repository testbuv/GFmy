    ...
    return (
        <>
            ...
            <main className="bg-black text-white py-12">
                <div className="max-w-6xl mx-auto bg-black p-8 rounded-lg shadow-md space-y-6 prose prose-blue">
             <h1 className="text-3xl font-bold mb-6 border-b pb-3 text-center text-white">PRIVACY POLICY</h1>
                    ...
                    <h2 className="text-2xl font-semibold text-white">Data Processing Purposes</h2>
                    ...
                    <h2 className="text-2xl font-semibold text-white">Third-Party Data</h2>
                    ...
                    <h2 className="text-2xl font-semibold text-white">Your Choices and Rights</h2>
                    ...
                    <h2 className="text-2xl font-semibold text-white">Privacy Policy Changes</h2>
