        ...
        <>
            ...
            <main className="bg-black text-white py-12">
                <div className="max-w-5xl mx-auto bg-black p-8 rounded-lg shadow-md space-y-6 prose prose-blue">
                    <h1 className="text-3xl font-bold mb-6 border-b pb-3 text-center text-white">COOKIES</h1>
                    
                    <section className="space-y-4">
                        <h2 className="text-2xl font-semibold text-white">WHAT IS A COOKIE?</h2>
                        <p>A cookie is a small text file that is saved on your computer when visiting a website. Growth Fast.io uses the information for statistical purposes, to track visitor activity on the page, and to improve and personalise the website user experience. There are two types of cookies – persistent and session cookies.</p>
                        <ol>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-semibold text-white">HOW ARE COOKIES USED?</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-semibold text-white">HOW DO I REMOVE COOKIES?</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-semibold text-white">WHAT COOKIES ARE USED AT growthfast.io.</h2>
