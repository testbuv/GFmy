            ...
            <main className="bg-gray-100 text-slate-950 py-12">
                <div className="max-w-5xl mx-auto bg-white p-8 rounded-lg shadow-md space-y-6 prose prose-blue">
                    ...
                    <section className="space-y-4">
                        ...
                        <p>A cookie is a small text file that is saved on your computer when visiting a website. Printifai uses the information for statistical purposes, to track visitor activity on the page, and to improve and personalise the website user experience. There are two types of cookies – persistent and session cookies.</p>
                        <ol>
                    ...
                    <section className="space-y-4">
                        ...
                        <p>Persistent cookies are used to e.g. save potential personal settings that you have chosen when browsing Printifai.shop, so that you can skip this step on consecutive visits. Session cookies are used to collect statistics on website usage.</p>
                        <p>By using Printifai website and/or agreeing to our Privacy and Confidentiality Policy and cookie information, you consent to our use of cookies. Please note that if you choose not to accept cookies by blocking/disabling them, you will not be able to purchase items from Printifai.shop. Additional site functionality may also be limited.</p>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-semibold text-slate-800">WHAT COOKIES ARE USED AT Printifai.shop?</h2>
                        <h3>BASIC FUNCTIONALITY:</h3>
                        <p>Printifai’s e-commerce platform set cookies in order for basic functionality of the site to work- check out, shopping cart etc.</p>
