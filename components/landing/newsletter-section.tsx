...
export const NewsletterSection: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full py-16 bg-black">
      <div className="w-full max-w-5xl relative rounded-[40px] [background:linear-gradient(180deg,_rgba(255,_255,_255,_0.4)_0.55%,_rgba(255,_255,_255,_0))] border-glass border-[1px] border-solid box-border p-8 md:p-12 flex flex-col items-center justify-between md:flex-row">
        <div className="md:hidden relative flex items-center justify-center mb-8">
        <Image src="/image8.png" alt="Newsletter" width={256}
              height={382} className="rounded-lg"
        ...
        <div className="space-y-4 md:w-1/2">
          ...
          <h1 className="text-2xl font-bold text-white md:text-3xl lg:text-4xl">Subscribe to our Newsletter!</h1>
